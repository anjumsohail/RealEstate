...
<ul class="nav navbar-nav navbar-right">
    <li class="dropdown">
        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#"> &nbsp;<i class="fa fa-user"></i> 
            @auth
            ...
            <li>                                    
                <div class="user-menu">
                    <div class="text-center">
                        <div class="user-image"><img class="img-responsive img-circle img-thumbnail" src="{{asset('img/avatar.png')}}"" ></div>
                        <strong>
                        @auth
                    ...
                    @else    
                        ...
                        <span><a href="{{ route('login') }}" class="btn-system border-btn btn-mini btn-green"> Sign In</a></span>
                        <div class="divider"></div>
                        <p>Don't have an Account, Register (Sign Up) to create your <strong>Account</strong> &amp; <strong>Post Your Property!</strong>.</p>
                        <span><a href="{{ route('register') }}" class="btn-system border-btn btn-mini btn-purple"> Register</a></span>
